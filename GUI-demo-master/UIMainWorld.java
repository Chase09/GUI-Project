...
public class UIMainWorld extends World
{
    ...
    private void testActors()
    {
         ...
         *          you want
         */
        Label label = new Label("ligma",69);
         ...
         */
        TextBox textbox = new TextBox("kowalski",24, true, Color.GREEN, Color.RED);
         ...
         */
        Menu menu = new Menu("Menu", "New \n Open \n Save \n Close \n Exit \n",18,Color.BLACK,Color.RED,Color.BLACK,Color.GREEN, new FileCommands());
